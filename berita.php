    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
            <div class="col-md-9 ftco-animate text-center">
                <p class="breadcrumbs"><span class="mr-2"><a href="home.php">Home</a></span> <span>Berita</span></p>
        ...
        <div class="row">
            <div class="col-lg-8 ftco-animate">
                <div class="row">
                    <?php
                    include "config.php";
                    $berita = mysqli_query($db, "SELECT * FROM berita ORDER BY kd_berita DESC");
                    ...
                    <div class="col-md-12 d-flex ftco-animate">
                        <div class="blog-entry align-self-stretch d-md-flex">
                            ...
                            <div class="text d-block pl-md-4">
                                <div class="meta mb-3">
                                   <div><a href="#">' . $array['tgl_berita'] . '</a></div>
		                  <div><a href="#">' . $array['penulis_berita'] . '</a></div>
		            
		                </div>
		                <h3 class="heading"><a href="#">' . $array['judul_berita'] . '</a></h3>
		          
                                <p><a href="detail_berita.php?kd_berita='.$array['kd_berita'].'" class="btn btn-primary py-2 px-3">Read more</a></p>
                            </div>
                        </div>
                    </div>
                    ';
            ...
            <div class="col-lg-4 sidebar ftco-animate">
                ...
                <div class="sidebar-box ftco-animate">
                    ...
                    <?php
                    include "config.php";
                    $berita = mysqli_query($db, "SELECT * FROM berita ORDER BY kd_berita ASC limit 5");
                    while ($array = mysqli_fetch_array($berita)) {
                        echo '
                    <div class="block-21 mb-4 d-flex">
                        ...
                        <div class="text">
                            ...
                            <div class="meta">
                                <div><a href="#"><span class="icon-calendar"></span>' . $array['tgl_berita'] . '</a></div>
