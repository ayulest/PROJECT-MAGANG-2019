        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown04">
                        <a class="dropdown-item" href="https://ppid.dinkesjatengprov.go.id/ppid/informasi-berkala/"
                           target="_blank">ORIENTASI
                            SIP ASDK SETOS 31 JULI</a>
                        <a class="dropdown-item" href="https://ppid.dinkesjatengprov.go.id/ppid/serta-merta/"
                           target="_blank">MATERI
                            PELAPORAN DATA <br> KES GE27_28 JUNI</a>
                        <a class="dropdown-item" href="https://ppid.dinkesjatengprov.go.id/ppid/informasi-setiap-saat/"
                           target="_blank">MONEV
...
<section class="ftco-section">
    <div class="container">
        <div class="col-md-7 heading-section ftco-animate">
            <h3>Orientasi SIP ASDK Setos 31 Juli</h3>
        </div>
        <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr class="[hide_empty:file_size]">
                            <td>File Size</td>
                            <th class="text-right">14.15 MB</th>
                        </tr>
                        <tr class="[hide_empty:file_type_icons]">
                            <td>File Type</td>
                            <th class="text-right"><img alt="rar" class="ttip" style="width:16px;height:16px;" src="https://dinkesjatengprov.go.id/v2018/core/modules/download-manager/assets/file-type-icons/rar.svg" original-title="rar"> </th>
                        </tr>
                        <tr class="[hide_empty:create_date]">
                            <td>Create Date</td>
                            <th class="text-right">1 August 2019</th>
                        </tr>
                    ...
                    <a class="wpdm-download-link btn btn-primary " rel="nofollow" href="#" onclick="location.href='https://dinkesjatengprov.go.id/v2018/download/orientasi-sip-asdk-setos-31-juli/?wpdmdl=2299';return false;">Download</a>
                </div>
            </div>

            <p align="justify">
                Sistem Informasi Kesehatan (SIK) terus berkembang seiring perkembangan teknologi informasi. Manajemen
                SIK terus disempurnakan mulai dari aspek atau komponen hardware, aplikasi, brainware serta mekanisme dan
                substansi data atau informasinya yang dikelola.
            </p>
            <p align="justify">
                Program open source yang bernama Aplikasi Satu Data Kesehatan dengan (ASDK) platform District Health
                Information System 2 (DHIS2) dapat dimanfaatkan untuk pengumpulan data, mengelola, dan menganalisis
                data. ASDK juga merupakan sistem yang dapat digunakan melakukan atau mengalirkan data dari dua sistem
                untuk kemudian keluar dalam satu dashboard penyajian data. Implementasi ASDK menekankan aspek integrasi
                sumber data baik di tingkat nasional maupun daerah. Berbagai sumber data diintegrasikan ke dalam ASDK
                yang menyediakan berbagai fitur untuk manajemen data, validasi, analisis, dan visualisasi data
                kesehatan.
            </p>
            <p align="justify">
                Tujuan pertemuan ini adalah untuk meningkatkan pemahaman dan kemampuan pengelola SIK
                Provinsi/Kabupaten/Kota dalam mengimplementasikan Aplikasi Satu Data Kesehatan dalam pengelolaan data
                dan informasi kesehatan.
            </p>
            <p align="justify">
                Pertemuan dilaksanakan di Kota Semarang selama tiga hari mulai tanggal 30 Juli s/d 1 Agustus 2019 di
                Hotel MG Setos, Semarang. Pertemuan diikuti oleh 45 orang peserta yang terdiri dari 35 orang pengelola
                SIK Kab/kota dan 10 orang pengelola SIK Dinas Kesehatan Provinsi.
            </p>
        </div>
    </div>
</section>
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="d-flex">
                        <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                            ...
                            <li><a href="http://ppid.jatengprov.go.id/" class="py-2 d-block"><img
                                            src="../images/ppid.png" width="50%"></a></li>
                        </ul>
                        <!--                        <ul class="list-unstyled">-->
