...
<section class="ftco-section">
    <div class="container">
        <div class="col-md-7 heading-section ftco-animate">
            <h3>Pertemuan Pencatatan dan Pelaporan Data Kesehatan Provinsi Jawa Tengah</h3>
        </div>
        <div class="row">
                ...
                <div class="col-md-12"><br>
                    <table class="table table-striped">
                        ...
                        <tr class="[hide_empty:file_size]">
                            <td>File Size</td>
                            <th class="text-right">15.42 MB</th>
                        </tr>
                        <tr class="[hide_empty:file_type_icons]">
                            <td>File Type</td>
                            <th class="text-right"><img alt="rar" class="ttip" style="width:16px;height:16px;"
                                                        src="https://dinkesjatengprov.go.id/v2018/core/modules/download-manager/assets/file-type-icons/rar.svg"
                                                        original-title="rar"></th>
                        </tr>
                        <tr class="[hide_empty:create_date]">
                            <td>Create Date</td>
                            <th class="text-right">28 June 2019</th>
                        </tr>
                        <tr class="[hide_empty:update_date]">
                            <td>Last Updated</td>
                            <th class="text-right">4 July 2019</th>
                        </tr>

                        </tbody>
                    </table>
                    <a class="wpdm-download-link btn btn-primary " rel="nofollow" href="#"
                       onclick="location.href='https://dinkesjatengprov.go.id/v2018/download/pertemuan-pencatatan-dan-pelaporan-data-kesehatan-provinsi-jawa-tengah/?wpdmdl=2188';return false;">Download</a>
                </div>
            </div>
            <div>
            <p align="justify"> <strong>Tujuan Umum :</strong></p>
            <ul>
                <li>Tujuan pertemuan ini adalah agar peserta mampu melaksanakan penguatan bank data kesehatan yang
                    mencakup
                    pengelolaan pencatatan dan pelaporan data
                </li>
            </ul>
                <p align="justify"><strong>Tujuan Khusus :</strong></p>
            <ul>
                <li>Memahami integrasi data kesehatan sebagai kebutuhan</li>
                <li>Melaksanakan penguatan bank data kesehatan di tingkat kabupaten/provinsi</li>
                <li>Melaksanakan evaluasi sistem pencatatan dan pelaporan posko mudik lebaran dan penyiapan laporan
                    nataru
                    2019
                </li>
            </ul>
                <p align="justify"><strong>Peserta pertemuan</strong> ini adalah 60 orang terdiri dari :</p>
            <ul>
                <li>35 orang Peserta Dinas Kesehatan Kabupaten/Kota</li>
                <li>25 orang peserta UPT dan Dinas Kesehatan Provinsi Jawa Tengah</li>
            </ul>
                <p align="justify"><strong>Narasumber Pertemuan</strong> Pencatatan dan Pelaporan Data Kesehatan Provinsi Jawa Tengah adalah
                :</p>
            <ul>
                <li>Pusdatin Kementerian Kesehatan</li>
                <li>Praktisi PSC 119</li>
                <li>Dinas Kesehatan Provinsi Jawa Tengah</li>
            </ul>
                <p align="justify"><strong>Waktu dan Tempat Pelaksanaan</strong></p>
            <ul>
                <li>Pertemuan Pencatatan dan Pelaporan Data Kesehatan Provinsi Jawa Tengah ini dilaksanakan pada tanggal
                    27 – 28
                    Juni 2019 di Semarang di Hotel Grand Edge Semarang.
                </li>
            </ul>
            <p>&nbsp;</p>
        </div>
