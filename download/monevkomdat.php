...
<section class="ftco-section">
    <div class="container">
        <div class="col-md-7 heading-section ftco-animate">
            <h3>Materi Monev Komdat 21 Mei 2019</h3>
        </div>
        <div class="row">
                ...
                <div class="col-md-12"><br>
                    <table class="table table-striped">
                        ...
                        <tr class="[hide_empty:file_size]">
                            <td>File Size</td>
                            <th class="text-right">7.12 MB</th>
                        </tr>
                        ...
                        <tr class="[hide_empty:create_date]">
                            <td>Create Date</td>
                            <th class="text-right">22 May 2019</th>
                        </tr>
                    ...
                    <a class="wpdm-download-link btn btn-primary " rel="nofollow" href="#" onclick="location.href='https://dinkesjatengprov.go.id/v2018/download/materi-monev-komdat-21-mei-2019/?wpdmdl=2097';return false;">Download</a>
                </div>

            </div>
            <div class="row">
                <div class="col-md-12" style="margin-top: 15px">
                    <p>Pertemuan Monitoring dan Evaluasi Komunikasi Data Provinsi Jawa Tengah, dilaksanakan pada :</p>
                    <p>Hari/ Tanggal : Selasa, 21 Mei 2019</p>
                    <p>Tempat&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; : Aula Mawar Lantai 8</p>
                    <p>Peserta&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: Pengelola SIK Kab/Kota</p>
                    <p>&nbsp;</p>
