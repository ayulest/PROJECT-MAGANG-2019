                            ...
                            <form action="proses-tambahberita.php" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                        ...
                                        <input type="text" class="form-control" name="penulis_berita" placeholder="Penulis Berita">
                                        <div class="invalid-feedback">
                                            Insert admin name.
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        <textarea class="form-control" name="isi_berita" rows="3" placeholder="Isi Berita"></textarea>
