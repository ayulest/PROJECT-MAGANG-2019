                    ...
                    <div class="page-header">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <button><a href="form-tambah-berita.php">Tambah Berita</a></button>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered first">
                                    ...
                                    while($berita = mysqli_fetch_array($query)){
                                        ...
                                        echo "<td style='width: 20%'>".$berita['judul_berita']."</td>";
                                        echo "<td style='width: 5%'>".$berita['gambar_berita']."</td>";
                                        echo "<td style='width: 5%'>".$berita['tgl_berita']."</td>";
                                        echo "<td style='align=justify; width: 70%'>".$berita['isi_berita']."</td>";
                                        echo "<td style='width: 5%'>".$berita['penulis_berita']."</td>";

                                        echo "<td style='width: 10%'>";
                                        echo "<a href='form-edit-berita.php?kd_berita=".$berita['kd_berita']."'>Edit</a> | ";
                                        echo "<a href='hapus.php?kd_berita=".$berita['kd_berita']."'>Hapus</a>";
                                        echo "</td>";
