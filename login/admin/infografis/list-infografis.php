    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid  dashboard-content">
                    ...
                    <div class="page-header">
                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <button><a href="form-tambah-infografis.php">Tambah Infografis</a></button>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Data Infografis</h5>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered first">
                                    ...
                                    while($infografis = mysqli_fetch_array($query)){
                                        ...
                                        echo "<td>".$no++."</td>";
                                        echo "<td>".$infografis['judul_infografis']."</td>";
                                        echo "<td>".$infografis['gambar_infografis']."</td>";

                                        echo "<td>";
                                        echo "<a href='form-edit-infografis.php?kd_infografis=".$infografis['kd_infografis']."'>Edit</a> | ";
                                        echo "<a href='hapus.php?kd_infografis=".$infografis['kd_infografis']."'>Hapus</a>";
                                        echo "</td>";
