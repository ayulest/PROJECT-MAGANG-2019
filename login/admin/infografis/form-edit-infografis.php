...
$sql = "SELECT * FROM infografis WHERE kd_infografis=$kd_infografis";
                        ...
                        <li class="nav-item ">
                            ...
                            <div id="submenu-1" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="list-infografis.php">Infografis</a>
                                    </li>
                                    <!--                                    <li class="nav-item">-->
    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid  dashboard-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Form Edit Infografis</h5>
                        <div class="card-body">
                            <form action="proses-edit-infografis.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <input type="hidden" name="kd_infografis" value="<?php echo $edit['kd_infografis'] ?>"/>

                                        <label for="judul_infografis">Judul Infografis</label>
                                        <input type="text" class="form-control" name="judul_infografis"
                                               placeholder="Judul Infografis" value="<?php echo $edit['judul_infografis'] ?>">
                                        <div class="valid-feedback">
                                            Looks good!
                                        </div>
                                    </div>
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <label for="file-input" class=" form-control-label">Foto</label></div>
