    ...
    <div class="dashboard-wrapper">
        <div class="container-fluid  dashboard-content">
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Form Tambah Infografis</h5>
                        <div class="card-body">
                            <form action="proses-tambah-infografis.php" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        <label for="judul_infografis">Judul Infografis</label>
                                        <input type="text" class="form-control" name="judul_infografis" placeholder="Judul Infografis" value="">
